...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("encerrrarJogo", function AppComponent_Template_app_painel_encerrrarJogo_1_listener($event) {
            return ctx.encerrarJogo($event);
          });
      ...
      directives: [_topo_topo_component__WEBPACK_IMPORTED_MODULE_1__["TopoComponent"], _painel_painel_component__WEBPACK_IMPORTED_MODULE_2__["PainelComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterOutlet"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/progresso/progresso.component.ts"); //DEVEMOS DECLARAR AQUI OS COMPONENTES FEITOS
    // NAS DECLARAÇÕES TBM;
  ...
  function srcAppPainelFrasesMockTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FRASES = [{
      ...
      frasePt: 'Estou com fome'
    }, {
      fraseEng: 'How are you?',
      frasePt: 'Como vai voce?'
    }, {
      fraseEng: 'Help me',
      frasePt: 'Ajude me'
    }, {
      fraseEng: 'Son of a bitch',
      frasePt: 'Filho da puta'
    }];
    /***/
  },
  ...
  function srcAppPainelPainelComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(PainelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} // FUNÇÃO DE ATUALIZAR RESPOSTA NO TEXT-AREA:
        ...
        key: "clearContents",
        value: function clearContents(element) {
          element.value = "";
        }
      }, {
        ...
        value: function verificarResposta() {
          ...
          if (this.rodadaFrase.frasePt == this.resposta) {
            ...
            this.rodada++; //Atualiza Progresso
            ...
            if (this.tentativas > 0) {
              alert("Tradução errada, tente novamente"); //this.coracaoCheio = this.coracaoVazio
    ...
    PainelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 21,
      vars: 4,
      consts: [[1, "container"], [1, "jumbotron", "mt-5", "py-4"], [1, "row"], [1, "col-sm-6"], [3, "progresso"], [1, "col-sm-6", "d-flex", "justify-content-end"], [1, "row", "px-3"], [1, "col"], [1, "form-group"], ["rows", "3", 1, "form-control", 3, "value", "input"], [1, "d-flex", "justify-content-end"], ["type", "button", 1, "btn", "btn-primary", 3, "click"]],
      template: function PainelComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function PainelComponent_Template_textarea_input_14_listener($event) {
  ...
  function srcAppProgressoProgressoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ProgressoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 3,
      consts: [[1, "progress", "bg-white"], ["role", "progressbar", "aria-valuenow", "20", "aria-valuemin", "0", "aria-valuemax", "100"]],
  ...
  function srcAppSharedCoracaoModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function Coracao(cheio) {
        ...
        var urlCoracaoVazio = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '/assets/coracao_vazioo.png';
    ...
    function () {
      ...
      */
      ...
      _createClass(TentativasComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {//  console.log('tentativas recebidas no painel: ', this.tentativas)
        }
      }]);
  ...
  function srcAppTopoTopoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! @angular/core */
    "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js"); //Importação do modulo, pego no node_modules @angular;
    ...
    TopoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 1,
      consts: [[1, "navbar", "navbar-layer", "bg-layer"], [1, "navbar-brand", "mb-0", "h1"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/leonardo/Documentos/angular/App1/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
